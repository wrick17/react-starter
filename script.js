...
/***/ function(module, exports, __webpack_require__) {
	...
	var Contacts = __webpack_require__(165);
	var ContactForm = __webpack_require__(168);
	var ContactDetails = __webpack_require__(181);
	...
	var ContactListApp = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'contacts-app-content' },
	        React.createElement(Contacts, { displayContactDetails: this.displayContactDetails, contacts: this.state.contacts, showContactForm: this.showContactForm }),
	        this.state.showContactDetails ? React.createElement(ContactDetails, { contact: this.state.contact }) : React.createElement(ContactForm, { sendData: this.sendData })
	      )
	    );
	  }
	});

	ReactDOM.render(React.createElement(ContactListApp, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".contacts-app .contacts-app-content {\n  display: flex;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var ContactList = __webpack_require__(171);
	...
	var Contacts = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      { className: 'contacts' },
	      React.createElement(Button, { title: 'Add New Contact', className: 'add-new-contact', onClick: this.props.showContactForm }),
	      React.createElement(ContactList, { displayContactDetails: this.props.displayContactDetails, contacts: this.props.contacts })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./contacts.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./contacts.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	var ContactForm = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'form',
	        { className: 'contact-form', onSubmit: this.addNewContact },
	        React.createElement('input', { autoFocus: true, ref: 'name', type: 'text', placeholder: 'Name', required: true }),
	        React.createElement('input', { ref: 'number', type: 'text', placeholder: 'Phone Number', required: true }),
	        React.createElement(Button, { type: 'submit', title: 'Save' }),
	        React.createElement(Button, { title: 'Cancel' })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./contactForm.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./contactForm.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	var ContactList = React.createClass({
	  ...
	  render: function () {
	    ...
	    var contactsArray = this.props.contacts.map(function (contact) {
	      return React.createElement(Contact, { displayContactDetails: that.props.displayContactDetails, name: contact.name, id: contact.id, key: contact.id, number: contact.number });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Contact = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'li',
	      { className: 'contact', onClick: this.displayContactDetails },
	      React.createElement(
	        'label',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./contactList.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./contactList.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Button = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      'button',
	      { onClick: this.props.onClick, type: this.props.type || 'button', className: classNames },
	      ' ',
	      this.props.title,
	      ' '
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./contactDetails.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./contactDetails.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".contact-details {\n  flex: 1 1 60%;\n  padding: 20px;\n  border: 1px solid;\n  margin: 5px;\n}\n", ""]);
